...
export default function RepaymentsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-brand-text mb-2">Repayments</h1>
        <p className="text-sm md:text-base text-brand-text-secondary">Track loan repayments</p>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-4 rounded-lg bg-brand-card-bg">
            ...
            <div className="flex-1">
              <p className="text-brand-text font-medium text-sm">No repayments recorded</p>
