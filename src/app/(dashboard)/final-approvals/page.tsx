...
export default function FinalApprovalsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-brand-text mb-2">Final Approvals</h1>
        <p className="text-sm md:text-base text-brand-text-secondary">Review and approve pending requests</p>
      </div>
