...
import { PiggyBank, DollarSign, TrendingUp, TrendingDown, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm md:text-base text-brand-text-secondary">High-level overview of financial performance</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <GlassCard className="p-6">
          ...
          <p className="text-brand-text-secondary text-sm mb-1">Dividends Distributed</p>
          <p className="text-brand-text text-2xl font-bold">₵0</p>
        </GlassCard>
        ...
        <GlassCard className="p-6">
          ...
          <p className="text-brand-text-secondary text-sm mb-1">Withdrawals</p>
          <p className="text-brand-text text-2xl font-bold">₵0</p>
        </GlassCard>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard className="p-6">
          <h3 className="text-xl font-semibold text-brand-text mb-4">Pending Approvals</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-brand-card-bg">
              <CheckCircle className="w-5 h-5 text-brand-warning" />
              <div className="flex-1">
                <p className="text-brand-text font-medium text-sm">No pending approvals</p>
