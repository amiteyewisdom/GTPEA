...
export default function WithdrawalHistoryPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-brand-text mb-2">Withdrawal History</h1>
        <p className="text-sm md:text-base text-brand-text-secondary">View your withdrawal transactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <GlassCard className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-brand-text-secondary text-sm">Total Withdrawals</span>
          </div>
      ...
      <GlassCard className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-4 rounded-lg bg-brand-card-bg">
            <ArrowUpCircle className="w-5 h-5 text-brand-text-secondary" />
            <div className="flex-1">
              <p className="text-brand-text font-medium text-sm">No withdrawal transactions found</p>
